...
/**
 * Main class for BoilerplateMcforge modification
 * <p>
 ...
 */
@Mod(
    modid = BoilerplateMcforge.MOD_ID,
...
public final class BoilerplateMcforge
{
     ...
     */
    public static final String MOD_ID = "boilerplatemcforge";
    ...
    /**
     * Logger instance for {@link BoilerplateMcforge}
     *
     * @see Logger
     * @see LogManager
     */
    static Logger logger = LogManager.getLogger(BoilerplateMcforge.class);
